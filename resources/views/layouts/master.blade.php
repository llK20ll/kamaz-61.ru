...
<html lang="ru">
    ...
    <![endif]-->
        <meta name="keywords" content="КАМАЗ Ростов, техника КАМАЗ, КАМАЗ самосвал, КАМАЗ бортовой, спецтехника КАМАЗ, КАМАЗ цена , КАМАЗ евро, КАМАЗ с прицепом, КАМАЗ тягач, КАМАЗ кран, дилеры КАМАЗ, продажа КАМАЗ, купить КАМАЗ, сервис КАМАЗ, официальный дилер КАМАЗ, КАМАЗ, Автоцентр КАМАЗ, КАМАЗТЕХОБСЛУЖИВАНИЕ, КАМАЗ 65117, КАМАЗ Манипулятор, КАМАЗ 43118, КАМАЗ 4308, КАМАЗ 53215, КАМАЗ зерновоз КАМАЗ 6520, КАМАЗ 45143, КАМАЗ 65201, КАМАЗ 65116, КАМАЗ 5490, КАМАЗ 65115, КАМАЗ фото, kamaz-61.ru, КАМАЗ61, КАМАЗ-61, КАМАЗ видео, новинки КАМАЗа, КАМАЗ мастер, Грузовые шины, запчасти КАМАЗ, каталог запчастей, КАМАЗ бензовоз, прицеп бортовой, грузовые прицепы, прицеп самосвал, продам прицеп, прицеп для автомобиля, автобус НЕФАЗ, продажа автобусов, КДМ, снегоуборочная машина, мусоровоз, пожарные автомобили, Автобетоносмеситель, АБС-7, АБС-9, АБС, Автогидроподъемник, АГП-18, АГП-22, АГП, автовышка купить, Купить КМУ, КАМАЗ с КМУ, КМУ, продажа манипуляторов, Утилизация, КАМАЗ Лизинг, Авто в лизинг, купить в лизинг, лизинг автомобилей, Программа субсидирования, государственное субсидирование, прицеп цистерна, полуприцеп цистерна, продажа прицепов, КАМАЗ на метане, полуприцеп, КАМАЗ официальный сайт, КАМАЗ центр, Магазин запчастей КАМАЗ, камаз в ростове, ростовский автоцентр камаз, купить камаз в Ростове-на-Дону, кран манипулятор, автокран, кран КАМАЗ, Ивановец, Галичанин, Клинцы, сельхозник, седельный тягач, автомобили КАМАЗ, техника камаз, акции на автомобили камаз, камаз в наличии, камаз по субсидии, камаз на выгодных условиях, шасси, бортовые автомобили, полуприцеп, прицеп, автоцистерна, АТЗ, БКМ, коммунальная техника, металловоз, сельскохозяйственная техника, автофургон, Самосвал КАМАЗ 6520, Самосвал КАМАЗ 65115, камаз 65115, Сельхозник КАМАЗ, Камаз 45143, Камаз с боковой разгрузкой, Седельный тягач КАМАЗ, тягач КАМАЗ 5490, камаз 5490, 5490, Neo, Седельный тягач КАМАЗ 54901, Камаз 54901, 54901, Новый модельный ряд КАМАЗ, Прицеп Нефаз, Прицеп СЗАП, Полуприцепы НЕФАЗ, Автопоезд, Сцепка КАМАЗ, Камаз 43253, камаз 65111, Камаз щука, камаз 6580, камаз 65801, камаз 65802, камаз 65207, камаз 65222, камаз 65209, Камаз 53605"/>
        <meta name="yandex-verification" content="ed3b30b4ccf79d52" />
        <meta name="google-site-verification" content="ifJ2xu2YdYROJvQync7G9spCuC7ER7cLQEbT8qwax6g" />
    ...
    <body>
        <div class="page">
            ...
            <nav class="navbar navbar-expand-xl navbar-light">
                ...
                <div class="logo-ac col-xs-6 mr-2">
                    <a href="{{route('index')}}" >                        
                        ...
                        <div>                   
                            ...
                            <ul class="nav navbar-nav navbar-right text-truncate">
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle text-center" href="{{route('home')}}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        @admin
                                            Админ
                                        @else
                ...
                <div class="d-flex justify-content-center m-auto">
                    ...
                    <a class="basketMainLink__row" @routeactive('basket*') href="{{route('basket')}}">                      
                        <div class="basketMainLink__column justify-content-center mx-1">
                    ...
                    <div class="header-phone">
                        <a class="phoneMy" href="tel:+79061815014">                        
                            ...
                            </svg><span class="pl-1">+7-906-181-50-14</span></span>
                        </a>
                        ...
                        <a class="callbackPhone" href="mailto:kamaz-rnd@yandex.ru">                        
                            ...
                            </svg><span class="pl-1">Kamaz-RND@yandex.ru</span></span>
                        </a>
                    </div>
                    {{-- блок контакты --}}
                ...
                <div class="d-flex justify-content-center">
                    <div class="footer-center">
                        <div class="col social wow">
                            ...
                            <a href="https://www.instagram.com/kamaz_61.ru/"><i class="fa fa-instagram"></i></a>                
                    ...
                    <div class="text-center pb-2">
                            ...
                            style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" class="ym-advanced-informer" data-cid="33824834" data-lang="ru" /></a>
                            <!-- /Yandex.Metrika informer -->

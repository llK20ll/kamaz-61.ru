...
Настоящая политика обработки персональных данных составлена в соответствии с требованиями <a class="privacy_link" href="http://www.consultant.ru/document/cons_doc_LAW_61801/">Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных»</a> и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Плещуновым Сергеем Владимировичем (далее – Оператор).<br>
1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.<br>
1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a class="privacy_link" href="https://kamaz-61.ru/">https://kamaz-61.ru</a>.<br>
<br>
...
2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a class="privacy_link" href="https://kamaz-61.ru/">https://kamaz-61.ru</a>;<br>
...
2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a class="privacy_link" href="https://kamaz-61.ru/">https://kamaz-61.ru</a>;<br>
2.9. Пользователь – любой посетитель веб-сайта <a class="privacy_link" href="https://kamaz-61.ru/">https://kamaz-61.ru</a>;<br>
...
4.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты <a class="privacy_link" href="mailto:kamaz-rnd@yandex.ru">kamaz-rnd@yandex.ru</a> с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях».<br>
...
5.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a class="privacy_link" href="https://kamaz-61.ru/">https://kamaz-61.ru</a>. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.<br>
...
8.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a class="privacy_link" href="mailto:kamaz-rnd@yandex.ru">kamaz-rnd@yandex.ru</a>.<br>
...
8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a class="privacy_link" href="https://kamaz-61.ru/privacy/">https://kamaz-61.ru/privacy/</a>.<br>
<br>
Обращаем Ваше внимание на то обстоятельство, что актуальность информации (количество, номенклатура, технические характеристики, стоимость и другие параметры реализуемого товара и (или) услуги), сроки поставки (оказания услуг) и т.д.), размещенной на сайте, в настоящее время может отличаться от фактической, в связи с чем в целях предупреждения неправильного информирования настоятельно рекомендуем обращаться за справочной информаций по размещенным на сайте телефонам. Вышеуказанные отклонения могут возникать по причинам постоянного совершенствования заводами-изготовителями своей продукции, внесения изменений в конструкцию, комплектацию, изменения ценовой политики наших поставщиков и нашего предприятия.
<br>
